  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body p-4 p-md-5">
        ...
        <form action="signin.php" class="login-form">
          <div class="form-group">
            <input type="text" name="username" class="form-control rounded-left" placeholder="Username">
          </div>
          <div class="form-group d-flex">
          ...
          <div class="form-group d-flex">
            <input type="tel" name="phone" class="form-control rounded-left" placeholder="Password">
          </div>
          <div class="form-group d-flex">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body p-4 p-md-5">
        ...
        <form action="contacts.php" class="login-form">
          <div class="form-group">
            <input type="text" name="username" class="form-control rounded-left " placeholder="Username">
          </div>
          ...
          <div class="form-group d-flex">
            <input type="email" class="form-control rounded-left mt-1" placeholder="email">
          </div>
          <div class="form-group">
            <button type="submit" class="form-control btn btn-primary rounded submit px-3 mt-3 ">add contact</button>
          </div>
          <div class="form-group d-md-flex">
            <div class="form-check w-50">
